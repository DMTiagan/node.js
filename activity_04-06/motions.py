...
def detect():
    ...
    while True:
        ...
        if motion_list[-1] == 1 and motion_list[-2] == 0:
            ...
            path = os.path.join('C:/Users/ACER/Downloads/node.js-main/node.js-main/activity_04-06', datetime.now().strftime("%Y-%m-%d-%H-%M-%S")+ '.jpg')

            cv2.imwrite(path, frame)

            img = convertToBinaryData(path)
            #print(img)

            data = {'stime':start_time , 'img':str(img)}
